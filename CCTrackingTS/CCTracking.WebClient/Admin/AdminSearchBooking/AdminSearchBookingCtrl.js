...
define(["require", "exports", "../../App", "../../Helper", "./AdminSearchBookingView", "../../Dtos/SearchDto", "../../DAL/AdminSearch", "marionette", "jquery", "knockout", "text!./SearchTmpl.html"], function(require, exports, application, helper, views, dto, DAL) {
    ...
    var AdminSearchBookingCtrl = (function (_super) {
        ...
        AdminSearchBookingCtrl.prototype.GetByCriteria = function (searchDto) {
            var _this = this;
        ...
        AdminSearchBookingCtrl.prototype.GetByCriteriaCompleted = function (searchDto) {
