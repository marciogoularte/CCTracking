    ...
    GetByCriteriaCompleted(bookingSummaryDto: dto.Models.BookingSummaryCollection) {
        ...
        for (var i = 0; i < result.length; i++) {
            summary[i] = {
                ...
                bookingAmount: result[i].bookingAmount,
                bookingMilage: result[i].bookingMilage,
                busNo: result[i].busNo,
                busId: result[i].busId,
                currentReading: result[i].currentReading,
                previusReading: result[i].previusReading,
                fuelQuantity: result[i].fuelQuantity,
                fuelRate: result[i].fuelRate,
                averageMilage: result[i].averageMilage,
